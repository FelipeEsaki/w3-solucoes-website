const servicos = [
    ...
    },
    {
        ...
        servico: 'Seguros',
        texto: `A W3 possui <strong>todos os tipos de seguros</strong> e <strong>mais de 10 seguradoras</strong> parceiras para melhor atender sua necessidade!`
    },
    {
        imagem: `assets/servicos/consorcio.jpg`,
        servico: 'Consórcios',
        texto: `A W3 oferece a <strong>melhor opção de consórcio</strong> de acordo com sua necessidade. Trabalhamos com todos os tipos de consórcios!`
    },
    {
    ...
    },
    {
        ...
        texto: `Está na hora de adquirir seu <strong>novo veículo</strong>! Com a W3 você tem as <strong>melhores taxas</strong> e opções de financiamento!`
    },
    {
        imagem: `assets/servicos/casa.jpg`,
        servico: 'Financiamento Residencial',
        texto: `Está na hora de adquirir sua <strong>nova casa</strong>! Com a W3 você tem as <strong>melhores taxas</strong> e opções de financiamento, refinanciamento e carta fiança!`
    },
    {
        imagem: `assets/servicos/conta.jpg`,
        servico: 'Abertura de conta',
        texto: `Abra sua conta bancária <strong>sem custo</strong>! Com a W3 você tem os <strong>melhores bancos</strong> para abrir sua conta bancária digital!`
    },
    {
    ...
    },
    {
        ...
        texto: `A W3 oferece <strong>diversas opções de maquininha de cartão</strong> com as <strong>melhores taxas</strong> do mercado! `
    },
    {
        imagem: `assets/servicos/cambio.png`,
        servico: 'Câmbio',
        texto: `A W3 oferece serviço de câmbio personalizado para cada situação!<strong> Temos na modalidade PF, PJ e Trade Finance</strong>! `
    },
    {
        imagem: `assets/servicos/recebiveis.png`,
        servico: 'Antecipação de Recebíveis',
        texto: `Nós da W3 trabalhamos na <strong>antecipação de títulos, Cartões, Fornecedores e também com descontos de duplicatas</strong>! `
    },
